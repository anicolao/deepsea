...
2. Open **Room code** and tell your friend the five letters. They open this preview, enter the code under **Join with code**, choose **Find room**, and join with their name. Lowercase letters work. **Copy invite** still shares a direct link. Both players see the same crew; guests cannot start the room.
