...
`ocean.png` is original project artwork generated with the built-in image generation tool on 2026-09-11. It is used behind the playable ocean path. The submarine and treasure markers are native vector/UI artwork, with textual equivalents.
