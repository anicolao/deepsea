...
Always commit and push requested fixes to the active PR; a local-only change is not a completed task. Resolve verification or deployment blockers and verify the updated preview before reporting completion.
